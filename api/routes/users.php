...
/**
* @OA\Get(path="/confirm/{token}", tags={"login"},  deion="Query for confirming user's accont with token",
*     @OA\Parameter(type="string", in="path", name="token", default=123, deion="Temporary token for activating account"),
*     @OA\Response(response="200", deion="Message upon successfull activation.")
* )
*/
...
/**
* @OA\Get(path="/admin/accounts", tags={"x-admin", "accounts"}, deion="Lists all users from database", security={{"ApiKeyAuth":{}}},
*     @OA\Parameter(type="integer", in="query", name="offset", default=0, deion="Offset for pagination"),
*     @OA\Parameter(type="integer", in="query", name="limit", default=15, deion="Limit the number of results"),
*     @OA\Parameter(type="string", in="query", name="search", deion="Search string for accounts (Case insensitive search)"),
*     @OA\Parameter(type="string", in="query", name="order", default="-id", deion="Sorting for return elements -column_name ascending, or +column_name descending"),
*     @OA\Response(response="200", deion="List accounts from database")
* )
*/
...
/**
* @OA\Get(path="/admin/account/{id}", tags={"x-admin", "accounts"}, deion="Fetches all information about a user by ID", security={{"ApiKeyAuth":{}}},
*     @OA\Parameter(@OA\Schema(type="integer"), in="path", name="id", example=1, deion="ID of the user"),
*     @OA\Response(response="200", deion="Fetch individual account")
* )
*/
...
/**
* @OA\Put(path="/admin/account/{id}", tags={"x-admin", "accounts"}, deion="Edit user's information by ID", security={{"ApiKeyAuth": {}}},
*   @OA\Parameter(@OA\Schema(type="integer"), in="path", name="id", default=1),
*   @OA\RequestBody(deion="Basic account info that is going to be updated", required=true,
*       @OA\MediaType(mediaType="application/json",
*    			@OA\Schema(
*    				 @OA\Property(property="username", type="string", example="Test_Username",	deion="User's username" ),
*    				 @OA\Property(property="fname", type="string", example="Ivan",	deion="User's first name" ),
*    				 @OA\Property(property="lname", type="string", example="Ivanov",	deion="User's last name" ),
*    				 @OA\Property(property="pass", type="string", example="querty123",	deion="User's password" ),
*    				 @OA\Property(property="email", type="string", example="example@mail.com",	deion="User's email address" ),
*    				 @OA\Property(property="phone", type="string", example="+123123123",	deion="User's phone address" )
*          )
*       )
*     ),
*     @OA\Response(response="200", deion="Update account based on id")
* )
*/
...
/**
* @OA\Put(path="/user/account/{id}", tags={"x-user", "accounts"}, deion="User edit it's personal information", security={{"ApiKeyAuth": {}}},
*   @OA\Parameter(@OA\Schema(type="integer"), in="path", name="id", default=1),
*   @OA\RequestBody(deion="Basic account info that is going to be updated", required=true,
*       @OA\MediaType(mediaType="application/json",
*    			@OA\Schema(
...
/**
* @OA\Get(path="/user/account", tags={"x-user", "accounts"}, deion="Query to get user's personal infrmation", security={{"ApiKeyAuth": {}}},
*     @OA\Response(response="200", deion="Fetch user account")
* )
*/
